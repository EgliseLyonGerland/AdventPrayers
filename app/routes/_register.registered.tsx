...
export default function Registered() {
  return (
    <Message heading="Reçu 5 sur 5 👩‍🚀">
      ...
      <div>
        Tu vas recevoir un email de confirmation à l’adresse que tu as indiquée
        dans le formulaire. Sache que je dois encore effectuer une validation
        manuelle pour confirmer ta participation à l’opération.
      </div>
      <div>
